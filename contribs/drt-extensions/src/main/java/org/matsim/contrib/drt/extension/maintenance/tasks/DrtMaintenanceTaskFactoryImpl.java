 ...
 * @author steffenaxer
 */
public class DrtMaintenanceTaskFactoryImpl implements MaintenanceTaskFactory {
	private final DrtTaskFactory delegate;

	public DrtMaintenanceTaskFactoryImpl(DrtTaskFactory delegate) {
		this.delegate = delegate;
	}

	@Override
	public DrtMaintenanceTask createMaintenanceTask(double beginTime, double endTime, Link link) {
		return new DrtMaintenanceTask(beginTime, endTime, link);
	}
