 ...
 */
class GraphAStarLandmarksData {

	private final static Logger LOG = LogManager.getLogger(GraphAStarLandmarksData.class);
	...
	private void findDeadEnds() {
		...
		Graph.LinkIterator outLI = this.graph.getOutLinkIterator();
		Graph.LinkIterator inLI = this.graph.getInLinkIterator();
