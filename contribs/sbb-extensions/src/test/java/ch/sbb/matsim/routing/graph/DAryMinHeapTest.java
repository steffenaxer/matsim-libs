...
public class DAryMinHeapTest {
	...
	public void testPoll() {
		...
		DAryMinHeap pq = new DAryMinHeap(20, 3, i -> cost[i], (i, c) -> cost[i] = c);
	...
	public void testDecreaseKey() {
		double cost[] = new double[10];
		DAryMinHeap pq = new DAryMinHeap(20, 4, i -> cost[i], (i, c) -> cost[i] = c);
	...
	public void stresstest() {
		...
		DAryMinHeap pq = new DAryMinHeap(cnt, 2, i -> cost[i], (i, c) -> cost[i] = c);
