 ...
 * </ul>
 *
 * <p>Anchor points are placed at five network sizes (50k, 100k, 300k, 750k, 1500k
 * nodes), calibrated from hand-tuned values for Berlin (~88k), Duesseldorf (~300k),
 * Metropole Ruhr (~752k), and extrapolated for very small and very large networks.
 *
 * @author Steffen Axer
 */
